...
if __name__ == '__main__':
    ...
    validTypes = ['-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=validators -SquareRowCM=3 -SquareColCM=3', '-validationType=square -SquareRowCM=3 -SquareColCM=3', '-validationType=square -SquareRowCM=4 -SquareColCM=4', '-validationType=square -SquareRowCM=5 -SquareColCM=5']
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/simData/driftExplorerBombSquareBig/Log_%d" % x)
