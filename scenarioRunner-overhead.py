...
if __name__ == '__main__':
    ...
    reclusterPeriod = ["-reclusterPeriod=%d" % d for d in [100, 200, 300, 400]]
    ...
    CHBatteryDropThresh = ["-CHBatteryDropThresh=%f" % f for f in [0.4]]
    ...
    TimeGRIncrementDecrement = ["-GRIncrement=%f -GRDecrement=%f" % (f[0],f[1]) for f in [(1,1)]]
    ...
    globalReclusterOptions = globalRecluster0 + globalRecluster2
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/git-simulator/CPS_Simulator/simData/overheadTest/Log_%d" % x)
