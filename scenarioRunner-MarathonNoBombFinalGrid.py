...
if __name__ == '__main__':
    ...
    gridStoredSample = ["-GridStoredSamples=%d" % d for d in [10, 20, 30, 40, 50]]
    ...
    validTypes = ["-validationType=square -SquareRowCM=3 -SquareColCM=3", "-validationType=square -SquareRowCM=4 -SquareColCM=4", "-validationType=square -SquareRowCM=5 -SquareColCM=5"]
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/simData/driftExplorerNoBombFinalGrid/Log_%d" % x)
