...
func GetFlags(p *Params) {
   ...
   -1 - off (heads only stop being head when they die or when global recluster occurs)
	...
	flag.Float64Var(&p.DisableCSThreshold, "disableCSThresh", 0.0, "When aliveNodes/totalNodes is less than this threshold, alone nodes will no longer search for cluster heads.")
