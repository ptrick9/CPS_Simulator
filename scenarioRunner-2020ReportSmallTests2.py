...
if __name__ == '__main__':
    ...
    smallImprovementRatio = ["-smallImprovementRatio=%f" % f for f in [0.1,0.25,0.33,0.5]]
    largeImprovement = ["-largeImprovement=%f" % f for f in [0.6,0.7,0.8,0.9]]
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/git-simulator/CPS_Simulator/simData/ReportSmallTests2/Log_%d" % x)
