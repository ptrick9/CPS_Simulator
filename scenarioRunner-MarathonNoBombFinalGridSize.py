...
if __name__ == '__main__':
    ...
    #Squares = ["-SquareRowCM=%d -SquareColCM=%d" % (d, d) for d in [6, 7, 8, 9, 10]]
    ...
    validTypes = ["-validationType=square -SquareRowCM=%d -SquareColCM=%d" % (d, d) for d in [2,4,6,8,10,12,14,16]]
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/simData/driftExplorerNoBombFinalGridFinalRun/Log_%d" % x)
