...
if __name__ == '__main__':
    ...
    GRIncrementDecrement = ["-GRIncrement=%f -GRDecrement=%f" % (f[0],f[1]) for f in [(1,1), (1.25,0.8), (1.5,0.7), (1.75,0.6), (2,0.5)]]
    ...
    for r in runs:
        for i in range(factor):
            j = [zz for zz in r]
            j.append("-OutputFileName=/home/simulator/git-simulator/CPS_Simulator/simData/ReportSmallTests3/Log_%d" % x)
